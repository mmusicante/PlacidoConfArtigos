...
Using the concepts {\sc Contract} and {\sc Assertion} it is possible to specify each activity service, by defining its pre- and post-conditions. \hl{The service that fits the {\sc Contract} and its {\sc Assertions} will be chosen and used in the execution flow.}
