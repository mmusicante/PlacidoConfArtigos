...
provides meta-classes to represent workflows%\footnote{Workflows will be transformed into (implemented) service compositions.} 
...
\item In order to represent constraint types associated to services compositions, we defined the me\-ta- classes {\sc Rule} and {\sc A-policy} (see blue\martin{Placido: Mudar as cores... } meta-classes in the $\pi$-Serv\-ice\-Com\-po\-si\-tion meta-model in Figure \ref{fig:e-scomposition-metamodel}).
...
To validate the applicability of our method we have developed a case study concerning risk assessment for financial companies as implemented by the ORCA System\footnote{The ORCA System is a trademark of GCP Global (www.gcpglobal.com).}.\martin{Is this a case study or a proof of concept?}
