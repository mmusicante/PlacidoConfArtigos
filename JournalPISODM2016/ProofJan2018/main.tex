...
\\[-12pt]
Copyright \textcopyright\ 2017 Inderscience Enterprises Ltd. & &%
\end{tabular*}%
\vskip -30pt%
%%\vskip -35pt%
\end{table}%
...
\affA{University Paris-Dauphine, PSL Research University, \\
CNRS, UMR 7243, Centre Lamsade, 75016 Paris, France\\
  E-mail: kbelhajj@googlemail.com}
  
\authorB{\sf Valeria~de~Castro}
\affB{Kybele Research Group, Rey Juan Carlos University, Madrid, Spain\\
  E-mail: valeria.decastro@urjc.es}

\authorC{\sf Javier~A.~Espinosa-Oviedo}
\affC{Barcelona Supercomputing Center (BSC), Barcelona, Spain
 and French-Mexican Laboratory of Informatics and Automatic Control (LAFMIA), Puebla, Mexico/ Grenoble, France\\
  E-mail: javiera.espinosa@bsc.es}
    
\authorD{\sf Martin A. Musicante and \\ Umberto Souza da Costa}
\affD{Department of Computer Science (DIMAp), \\ 
...
\authorE{\sf Pl\'acido~A.~Souza~Neto$^*$}
\affE{Federal Institute for Education, Science and Technology \\
of Rio Grande do Norte, Natal, Brazil\\
  E-mail: placido.neto@ifrn.edu.br\\
  *Corresponding author}  

\authorF{\sf Genoveva~Vargas-Solar}
\affF{Univ. Grenoble Alpes, CNRS, Institute of Engineering Univ. Grenoble Alpes (Grenoble INP), LIG, 38000 Grenoble, France and
	French-Mexican Laboratory of Informatics and Automatic Control (LAFMIA), Puebla, Mexico/ Grenoble, France
	\\
  E-mail: genoveva.vargas@imag.fr}  

\authorG{\sf Jos\'e-Luis~Zechinelli-Martini}
\affG{University of the Americas-Puebla, Cholula, Mexico and
	French-Mexican Laboratory of Informatics and Automatic Control (LAFMIA), Puebla, Mexico/ Grenoble, France\\
...
\REF{to this paper should be made as follows: Khalid Belhajjame, Valeria~de~Castro, Javier~A.~Espinosa-Oviedo, Martin~A.~Musicante, Umberto~Souza~da~Costa, Pl\'acido~A.~Souza~Neto, Genoveva~Vargas-Solar, Jos\'e-Luis~Zechinelli-Martini (xxxx) `\pisodm: Building SOC Applications in the Presence of Non-Functional Requirements', {\it International Journal of Web and Grid Services}, Vol. x, No. x, pp.xxx\textendash xxx.}
...
\noindent This paper is a revised and expanded version of a paper entitled ``Supporting Non-functional Requirements in Services Software Development Process: An MDD Approach'' presented at SOFSEM 2014, Nov\'y Smokovec, High Tatras, Slovakia, January 25-30, 2014~\cite{Placido2014}.
\end{bio}
...
The \textit{$\pi$-UseCase} meta-model extends the UML Use Case meta-model to describe NFRs with  the following  concepts:  \textsc{Business service}\footnotemark \footnotetext{We use the 
...
They can be also immaterial restrictions such as the protocol used for accessing data on the company's computer server.}.
