...
\textit{(ii)} embraces the MDA philosophy, thereby generating (instead of manually developing) models (code) whenever possible.
The proposed solution has been utilized in the context of an industrial case study.
\end{abstract}
...
%\label{sec:modeling}
%(comentar la revisi��n y presentar la clasificacion de conceptos y NFR model con los conceptos que proponemos)
%\input{modelingNFR}
...
%(Aqu�� lo dejar��a con la estructura que ten��amos para Caise, presentamos el framework y posteriormente comentamos modelos y transformaciones)
