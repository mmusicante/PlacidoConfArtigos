...
Beside the existence of these works, it is important to remark that authors continue emphasizing the limited attention of the model-driven proposals for service development to non-functional requirements~\cite{Ameller201542,Ameller2010}. As Ameller et al. realize in a recent published literature review \textit{"Not many papers that presented a generic approach to deal with NFRs"}. Authors also remark in such study the lacks of industrial use case~\cite{Ameller201542}. Our method to develop service-oriented applications aims to cover this lack of proposals dealing with non-functional requirements and gives support in addition to real need presented in a company related to the risk assessment industry.
