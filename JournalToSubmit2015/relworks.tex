...
Beside the existence of these works, it is important to remark that authors continue emphasizing the limited attention of the model-driven proposals for service development to non-functional requirements~\cite{Ameller201542,Ameller2010}. As Ameller et al. realize in a recent published literature review that there are \textit{``Not many papers that presented a generic approach to deal with NFRs"}. Authors also remark in such study the lack of industrial use cases~\cite{Ameller201542}. 
