...
Given the "download music" use case of the scenario example, it includes the payment process to buy the music. It is represented as a include in the $\pi$-UseCase model and it is transformed in a sequence flow in the $\pi$-Service process model (as shown in figure \ref{fig:transformation-example-include}). 
\end{example}
