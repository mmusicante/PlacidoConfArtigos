...
The main ideas of MDD were originaly proposed by the Object Management Group (OMG)~\cite{mda} and provides a set of guidelines for the structuring of specifications.
...
Inter-level transformation implement the refinement process between levels.
...
Thus, organizations are  seeking for mechanisms to deal with the gap between the systems developed and business needs~\cite{bell}. 
