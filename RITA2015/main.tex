...
The selection of services is usually guided by the \textit{functional}\footnote{Functional properties of a computer system are characterized by the effect produced by the system when given a defined input.} requirements of the application being developed~\cite{2,decastro1,PapazoglouH06}.
...
%\bigskip
%*****OJO**** QUITAR!! ESTA DISTINCION NO APARECE EN REALIDAD EN EL PAPER NO???, YO QUITARIA SIN MAS ESTE UTLIMO PARRAFO SALVO QUE LE VEAN SENTIDO****
...
\begin{figure*}
\centering
\includegraphics[width=1.0\textwidth]{./figures/piSOD-M_process.pdf}
...
\begin{figure*}
\center
\includegraphics[width=0.75\textwidth]{./figures/e3value.pdf}
\hspace*{5cm}\includegraphics[width=0.4\textwidth]{./figures/3ValueKey.pdf}
...
\begin{figure}
\center
\includegraphics[width=0.45\textwidth]{./figures/SC.pdf}
...
%Thus, the services functions can be specified as being grouped into packages.
 ...
 \begin{figure*}
\center
\includegraphics[width=0.9\textwidth]{./figures/UseCaseMetaModel.pdf}
...
\begin{figure*}
\center
\includegraphics[width=0.9\textwidth]{./figures/UseCase.pdf}
...
\begin{figure*}
\center
\includegraphics[width=0.9\textwidth]{./figures/ServiceProcessMetaModel.pdf}
...
\begin{figure*}
\center
\includegraphics[width=0.9\textwidth]{./figures/ServiceProcess.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=1.0\textwidth]{./figures/PiServiceComposition}
...
\begin{figure*}
\centering
\includegraphics[width=0.75\textwidth]{./figures/PEWSMetamodel}
...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{./figures/pi-pewsSpecification-toPublishMusic}
...
%\begin{figure}
%\centering{
%\includegraphics[width=0.96\textwidth]{35}}
...
%\begin{figure}
%\centering{
%\includegraphics[width=0.80\textwidth]{37}}
...
%\begin{figure}
%\centering{
%\includegraphics[width=0.96\textwidth]{36}}
...
%\begin{figure}
%\centering{
%\includegraphics[width=0.76\textwidth]{38}}
...
%\begin{figure}
%\centering{
%\includegraphics[width=0.96\textwidth]{ExceptionalRules}}
...
%\begin{figure}
%\centering{
%\includegraphics[width=1\textwidth]{ServiceProcess-ServiceComposition}}
...
%\begin{figure}
%\centering{
%\includegraphics[width=0.96\textwidth]{Table7}}
...
\begin{figure*}
\centering
\includegraphics[width=0.9\textwidth]{./figures/3ValueModel.pdf}
\hspace*{5cm}\includegraphics[width=0.4\textwidth]{./figures/3ValueKey.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=1.0\textwidth]{./figures/BPMN_GCP.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.9\textwidth]{./figures/UseCaseGeneral.png}
